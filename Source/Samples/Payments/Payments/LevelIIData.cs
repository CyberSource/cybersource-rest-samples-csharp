...
namespace Cybersource_rest_samples_dotnet.Samples.Payments
{
    public class LevelIIData
    {
        ...
        {
            string clientReferenceInformationCode = "TC50171_12";
            ...
            string orderInformationAmountDetailsTotalAmount = "112.00";
            ...
            string orderInformationInvoiceDetailsPurchaseOrderNumber = "LevelII Auth Po";
