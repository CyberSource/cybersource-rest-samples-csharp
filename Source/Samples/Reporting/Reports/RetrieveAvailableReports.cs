...
namespace Cybersource_rest_samples_dotnet.Samples.Reporting
{
    public class RetrieveAvailableReports
    {
        ...
        public static ReportingV3ReportsGet200Response Run()
        {
            ...
            var startTime = DateTime.ParseExact("2025-01-01T00:00:00Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
            var endTime = DateTime.ParseExact("2025-01-03T23:59:59Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
