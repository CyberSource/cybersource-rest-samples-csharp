...
namespace Cybersource_rest_samples_dotnet.Samples.Reporting
{
    public class GetPurchaseAndRefundDetails
    {
        ...
        {
            var startTime = DateTime.ParseExact("2020-01-01T12:00:00Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
            var endTime = DateTime.ParseExact("2020-01-30T12:00:00Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
