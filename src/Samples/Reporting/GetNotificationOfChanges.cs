...
namespace Cybersource_rest_samples_dotnet.Samples.Reporting
{
    public class GetNotificationOfChanges
    {
        ...
        {
            var startTime = DateTime.ParseExact("2019-09-01T12:00:00Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
            var endTime = DateTime.ParseExact("2019-09-10T12:00:00Z", "yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
            try
            {
