...
namespace Cybersource_rest_samples_dotnet.Samples.Payments
{
    public class ProcessPaymentSimpleAuthorizationRetail
    {
        ...
        {
            string clientReferenceInformationCode = "TC50171_8";
            ...
            string paymentInformationCardNumber = "5555555555554444";
            ...
            string orderInformationAmountDetailsTotalAmount = "108.00";
            ...
            string pointOfSaleInformationTerminalId = "001";
            ...
            Ptsv2paymentsPointOfSaleInformation pointOfSaleInformation = new Ptsv2paymentsPointOfSaleInformation(
                TerminalId: pointOfSaleInformationTerminalId,
